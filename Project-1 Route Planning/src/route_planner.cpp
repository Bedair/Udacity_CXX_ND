...
bool CompareNode(RouteModel::Node *n1, RouteModel::Node *n2)
{
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    RouteModel::Node * n_ptr = open_list.front();
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    {
        // Add distance from Current Node to parent
    ...
    // reverse the path to start with Start Node
